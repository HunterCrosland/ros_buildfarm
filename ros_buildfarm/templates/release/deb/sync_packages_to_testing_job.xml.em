...
@(SNIPPET(
    ...
    script='\n'.join([
        ...
        'python3 -u $WORKSPACE/ros_buildfarm/scripts/wrapper/git.py clone --depth 1 -b refactor https://github.com/HunterCrosland/reprepro-updater.git reprepro-updater',
